...
if len(sys.argv)!=6:
    print("Usage: ")
    print("python extract_features_world.py <path_to_data_dir> <sampling rate> <path_to_WORLD_dir> <path_to_REAPER_dir> <path_to_SPTK_dir> ")
    sys.exit(1)
...
mgc_dir = os.path.join(data_dir, 'mgc')
ap_dir  = os.path.join(data_dir, 'ap' )
bap_dir = os.path.join(data_dir, 'bap')
...
print("You should have your features ready in: "+data_dir)    
